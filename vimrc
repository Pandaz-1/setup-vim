" ----- Ini hanyalah vimrc default yang ditambah dengan beberapa konfigurasi ----- "
...
" ----- TEMA EDITOR ----- "
"  Kalian bisa mengganti 'gruvbox' dengan 'monokai' ataupun dengan tema yang lainnya asalkan pluginnya telah kalian install
colorscheme gruvbox
set background=dark
